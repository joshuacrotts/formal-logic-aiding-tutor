 ...
 */
public class TopPaneProperties extends FxPropertyExtension {

    public TopPaneProperties () {
        super(new BorderProperties(Color.BLACK, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(0, 0, BorderData.WIDTH, 0)),
