 ...
 */
public class DoubleTurnstileMenuItem2 extends LogicContextMenuItem {

    public DoubleTurnstileMenuItem2 () {
        super(Controller.MAPPED_TEXT.getValue(DoubleTurnstileSymbol.class, LogicSymbol.Keys.ALTERNATE_2));
    }
