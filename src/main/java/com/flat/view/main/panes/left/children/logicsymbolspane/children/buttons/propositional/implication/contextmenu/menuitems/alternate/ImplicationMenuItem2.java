 ...
 */
public class ImplicationMenuItem2 extends LogicContextMenuItem {

    public ImplicationMenuItem2 () {
        super(Controller.MAPPED_TEXT.getValue(ImplicationSymbol.class, LogicSymbol.Keys.ALTERNATE_2));
    }
