 ...
 */
public class ConjunctionMenuItem3 extends LogicContextMenuItem {

    public ConjunctionMenuItem3 () {
        super(Controller.MAPPED_TEXT.getValue(ConjunctionSymbol.class, LogicSymbol.Keys.ALTERNATE_3));
    }
