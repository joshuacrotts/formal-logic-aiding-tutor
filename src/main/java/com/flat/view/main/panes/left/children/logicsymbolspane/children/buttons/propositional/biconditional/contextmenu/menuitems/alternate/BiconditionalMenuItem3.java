 ...
 */
public class BiconditionalMenuItem3 extends LogicContextMenuItem {

    public BiconditionalMenuItem3 () {
        super(Controller.MAPPED_TEXT.getValue(BiconditionalSymbols.class, LogicSymbol.Keys.ALTERNATE_3));
    }
