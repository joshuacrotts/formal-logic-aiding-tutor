 ...
 */
public class NegationMenuItem4 extends LogicContextMenuItem {

    public NegationMenuItem4 () {
        super(Controller.MAPPED_TEXT.getValue(NegationSymbol.class, LogicSymbol.Keys.ALTERNATE_4));
    }
