 ...
 */
public class DisjunctionMenuItem2 extends LogicContextMenuItem {

    public DisjunctionMenuItem2 () {
        super(Controller.MAPPED_TEXT.getValue(DisjunctionSymbol.class, LogicSymbol.Keys.ALTERNATE_2));
    }
