 ...
 */
public class ImplicationMenuItem3 extends LogicContextMenuItem {

    public ImplicationMenuItem3 () {
        super(Controller.MAPPED_TEXT.getValue(ImplicationSymbol.class, LogicSymbol.Keys.ALTERNATE_3));
    }
