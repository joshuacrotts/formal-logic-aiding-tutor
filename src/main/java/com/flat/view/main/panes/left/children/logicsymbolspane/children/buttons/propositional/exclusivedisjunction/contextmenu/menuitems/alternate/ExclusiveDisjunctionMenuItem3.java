 ...
 */
public class ExclusiveDisjunctionMenuItem3 extends LogicContextMenuItem {

    public ExclusiveDisjunctionMenuItem3 () {
        super(Controller.MAPPED_TEXT.getValue(ExclusiveDisjunctionSymbol.class, LogicSymbol.Keys.ALTERNATE_3));
    }
