 ...
 */
public class ImplicationMenuItem4 extends LogicContextMenuItem {

    public ImplicationMenuItem4 () {
        super(Controller.MAPPED_TEXT.getValue(ImplicationSymbol.class, LogicSymbol.Keys.ALTERNATE_4));
    }
