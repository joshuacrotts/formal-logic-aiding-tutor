 ...
 */
public class NegationMenuItem2 extends LogicContextMenuItem {

    public NegationMenuItem2 () {
        super(Controller.MAPPED_TEXT.getValue(NegationSymbol.class, LogicSymbol.Keys.ALTERNATE_2));
    }
