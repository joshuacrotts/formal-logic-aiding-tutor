 ...
 */
public class UniversalMenuItem2 extends LogicContextMenuItem {

    public UniversalMenuItem2 () {
        super(Controller.MAPPED_TEXT.getValue(UniversalSymbol.class, LogicSymbol.Keys.ALTERNATE_2));
    }
