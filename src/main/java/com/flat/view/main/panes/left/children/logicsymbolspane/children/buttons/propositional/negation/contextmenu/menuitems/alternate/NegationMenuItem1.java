 ...
 */
public class NegationMenuItem1 extends LogicContextMenuItem {

    public NegationMenuItem1 () {
        super(Controller.MAPPED_TEXT.getValue(NegationSymbol.class, LogicSymbol.Keys.ALTERNATE_1));
    }
