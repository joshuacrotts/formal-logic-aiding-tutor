 ...
 */
public class ExclusiveDisjunctionMenuItem1 extends LogicContextMenuItem {

    public ExclusiveDisjunctionMenuItem1 () {
        super(Controller.MAPPED_TEXT.getValue(ExclusiveDisjunctionSymbol.class, LogicSymbol.Keys.ALTERNATE_1));
    }
