 ...
 */
public class TurnstileMenuItem1 extends LogicContextMenuItem {

    public TurnstileMenuItem1 () {
        super(Controller.MAPPED_TEXT.getValue(TurnstileSymbol.class, LogicSymbol.Keys.ALTERNATE_1));
    }
