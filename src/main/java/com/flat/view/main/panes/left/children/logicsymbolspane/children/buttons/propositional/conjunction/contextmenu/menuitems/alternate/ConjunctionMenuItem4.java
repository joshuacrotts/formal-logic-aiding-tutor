 ...
 */
public class ConjunctionMenuItem4 extends LogicContextMenuItem {

    public ConjunctionMenuItem4 () {
        super(Controller.MAPPED_TEXT.getValue(ConjunctionSymbol.class, LogicSymbol.Keys.ALTERNATE_4));
    }
