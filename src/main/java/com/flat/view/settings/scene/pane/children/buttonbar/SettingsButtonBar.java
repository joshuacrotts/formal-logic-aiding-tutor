...
public class SettingsButtonBar extends ButtonBar {
    private final SettingsApplyButton settingsApplyButton = new SettingsApplyButton();
    private final SettingsCloseButton settingsCloseButton = new SettingsCloseButton();
