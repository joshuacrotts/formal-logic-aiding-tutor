package com.flat.models.data.settings.tabs.advance.content.alert;
 ...
 */
public class AdvanceAlert extends Translatable implements Serializable {
    ...
    private KeyedText message = new KeyedText(AdvanceAlert.class, Keys.MESSAGE, "Message");
    private KeyedText messageText = new KeyedText(AdvanceAlert.class, Keys.MESSAGE_TEXT, "Timeout values were updated.");
    private KeyedText error = new KeyedText(AdvanceAlert.class, Keys.ERROR, "Error");
    private KeyedText errorText = new KeyedText(AdvanceAlert.class, Keys.ERROR_TEXT, "Please ensure values are within the specified range.");
    private KeyedText ok = new KeyedText(AdvanceAlert.class, Keys.OK, "Ok");
    ...
    public String toString() {
        return "AdvanceAlert{" + "message=" + message + ", messageText=" + messageText + ", error=" + error + ", errorText=" + errorText + ", ok=" + ok + '}';
    }
