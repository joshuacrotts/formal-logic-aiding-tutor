...
import com.flat.algorithms.ConjunctiveNormalFormDetector;
...
public class ConjunctiveNormalFormDetectorUnitTester {

    private static ConjunctiveNormalFormDetector cnfConverter;
    ...
    /**
     * The testing engine for a valid FLAT well-formed formula (which should parse and
    ...
    private static void goodFileTest(String testName) {
        String inName = "src/main/resources/testdata/cnf/" + testName + ".in";
        String expName = "src/main/resources/testdata/cnf/" + testName + ".out";
        ...
        cnfConverter = new ConjunctiveNormalFormDetector(syntaxTree);
        System.out.println(cnfConverter.getConjunctiveNormalForm().getStringRep());
